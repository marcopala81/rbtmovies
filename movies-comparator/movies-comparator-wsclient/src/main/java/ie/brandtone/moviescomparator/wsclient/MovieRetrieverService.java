...
public interface MovieRetrieverService
{
	 ...
	 * @throws WsClientConfigException in case of any webserviceclient configuration issue
	 * 
	 * @since v1.0.0
	 */
	public Movie getMovieByTitle(String title) throws MovieNotFoundException, BadMovieFormatException, WsClientConfigException;
}
